...
*         _/      _/  _/  _/_/_/   _/_/_/      *
*        _/_/_/  _/_/_/  _/   _/  _/           *
*    2015 Dev-KM - DevMol    _/ _/_/_/_/       *
* -------------------------------------------- * 
* - Developer(s): KM - Maol                    *
* - Contacto: krizttian@live.com               *
* - Contacto: martinalejandro1997@gmail.com    *
...
extern int main(int argc, char **argv)
{
    ...
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "%s (authserver-FixCore)", _FULLVERSION);
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "<Ctrl-C> para detener.\n");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "Usando configuracion del archivo %s.", cfg_file);
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "                                                           ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *==============================================*  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *	  _/_/_/  _/_/_/                          *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *     _/        _/   _/   _/                   *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *    _/_/_/    _/     _/_/                     *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *   _/        _/      _/_/                     *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *  _/      _/_/_/   _/   _/                    *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *                            FixCore 4.3.4     *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *           _/_/_/  _/_/_/  _/_/_/   _/_/_/    *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *          _/      _/  _/  _/  _/   _/         *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *         _/      _/  _/  _/_/_/   _/_/_/      *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *        _/_/_/  _/_/_/  _/   _/  _/           *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         *    2015 Dev-KM             _/ _/_/_/_/       *  ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "         * -------------------------------------------- *  ");
	sLog->outWarn(LOG_FILTER_AUTHSERVER, "                                                                     ");
    sLog->outWarn(LOG_FILTER_AUTHSERVER, "%s (Librerias: %s)", OPENSSL_VERSION_TEXT, SSLeay_version(SSLEAY_VERSION));
