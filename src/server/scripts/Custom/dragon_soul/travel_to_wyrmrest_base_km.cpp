...
class travel_to_wyrmrest_base_km : public CreatureScript
{
public:
    travel_to_wyrmrest_base_km() : CreatureScript("travel_to_wyrmrest_base_km") { }
    ...
    bool OnGossipHello(Player* pPlayer, Creature* pCreature)
    {
		...
		pPlayer->ADD_GOSSIP_ITEM(1, "Base", GOSSIP_SENDER_MAIN, 1);
		  ...
		  case 1:
              {
                  ...
                  pPlayer->TeleportTo(967, -1793.22f, -2391.78f, 45.604f, 5.871f);
			 }break;
			  {
...
{
    new travel_to_wyrmrest_base_km();
}
