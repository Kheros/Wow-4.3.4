...
class travel_to_the_eye_of_eternity_km : public CreatureScript
{
public:
    travel_to_the_eye_of_eternity_km() : CreatureScript("travel_to_the_eye_of_eternity_km") { }
    ...
    bool OnGossipHello(Player* pPlayer, Creature* pCreature)
    {
		...
		pPlayer->ADD_GOSSIP_ITEM(1, "Hagara", GOSSIP_SENDER_MAIN, 1);
		  ...
		  case 1:
              {
                  ...
                  pPlayer->TeleportTo(967, 13629.7f, 13611.9f, 123.482f, 3.468f);
			 }break;
			  {
...
{
    new travel_to_the_eye_of_eternity_km();
}
