...
class npc_nethestrasz_km : public CreatureScript
{
public:
    npc_nethestrasz_km() : CreatureScript("npc_nethestrasz_km") { }
    ...
    bool OnGossipHello(Player* pPlayer, Creature* pCreature)
    {
		...
		pPlayer->ADD_GOSSIP_ITEM(1, "Ultraxion", GOSSIP_SENDER_MAIN, 1);
		  ...
		  case 1:
              {
                  ...
                  pPlayer->TeleportTo(967, -1786.69f, -2393.67f, 341.355f, 0.16f);
			 }break;
			  {
