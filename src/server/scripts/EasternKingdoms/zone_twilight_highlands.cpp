...
public:
    ...
    struct npc_cadaver_collageAI : public ScriptedAI
    {
        ...
        {
            if(!inhaled && !me->IsNonMeleeSpellCasted(false) && HealthBelowPct(20))
            {
...
public:
    ...
    struct npc_lord_geofferyAI : public ScriptedAI
    {
        ...
        void DamageTaken(Unit* /*attacker*/, uint32& /*damage*/)
        {
            if(!transformed && !me->IsNonMeleeSpellCasted(false) && HealthBelowPct(20))
            {
               transformed = true;
...
public:
    ...
    struct npc_gloomwingAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            if (Unit* playersearch = me->FindNearestPlayer(300.0f, true))
