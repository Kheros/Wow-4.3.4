...
void AddSC_npc_nethestrasz_km();
void AddSC_npc_valeera_km();
void AddSC_travel_to_the_deck_of_the_skyfire_km();
void AddSC_travel_to_the_eye_of_eternity_km();
void AddSC_travel_to_wyrmrest_base_km();
...
void AddCustomScripts()
{
	...
	AddSC_global_teleporter();
	AddSC_cs_world_chat();
	AddSC_System_Censure();
	AddSC_npc_shop();
	AddSC_PvP_System();
	AddSC_npc_incansable_km();
	...
	AddSC_skills_on_first_login();
	AddSC_login_announce();
	AddSC_casino_km();
	AddSC_gamble_npc();
	AddSC_title_granter();
	AddSC_Morph_npc();
//Alma de Dragon
	AddSC_npc_eiendormi_km();
	AddSC_npc_nethestrasz_km();
	AddSC_npc_valeera_km();
	AddSC_travel_to_the_deck_of_the_skyfire_km();
	AddSC_travel_to_the_eye_of_eternity_km();
	AddSC_travel_to_wyrmrest_base_km();
