...
int Master::Run()
{
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "<Ctrl-C> para detener.\n");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "FixCore 4.3.4");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "DevKM");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "%s (worldserver-fixcore)", _FULLVERSION);
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "                                                          ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *==============================================* ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *      _/_/_/  _/_/_/                          * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *     _/        _/   _/   _/                   * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *    _/_/_/    _/     _/_/                     * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *   _/        _/      _/_/                     * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *  _/      _/_/_/   _/   _/                    * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *                                              * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *           _/_/_/  _/_/_/  _/_/_/   _/_/_/    * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *          _/      _/  _/  _/  _/   _/         * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *         _/      _/  _/  _/_/_/   _/_/_/      * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *        _/_/_/  _/_/_/  _/   _/  _/           * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *    2015 Dev-KM             _/ _/_/_/_/       * ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "         *==============================================* ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "                                                                     ");
